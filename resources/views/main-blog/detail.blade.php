...
@section('content')
    ...
    <body class="dark">
        <a href="/show" class="btn btn-secondary mt-5"><i class="uil uil-arrow-left"></i></a>
                    ...
                    <div id="comment-form-container" style="display: none;" class="mt-3">
                        <form id="comment-form" action="/addcomment/{{ $blog->id }}" method="POST"
                            ...
                            <div class="d-flex">
                                <div class="row">
                                    <div class="col-md-11">
                                        <textarea class="required form-control border-0 bg-contrast-200" id="desc_comment" name="desc_comment"
                    ...
                    <div class="card container">
                        @foreach ($comments as $comment)
                            <div class="topic-post mt-3">
                                ...
                                <div class="mt-1 d-flex" style="margin-left: 68px">
                                    ...
                                    <!-- Tombol Balas -->
                                    <a href="javascript:void(0);" class="text-muted ms-2 fw-bold" style="font-size: 12px"
                                    ...
                                    <div class="replies-toggle mt-3" style="margin-left: 65px">
                                        <p style="font-size: 13px">
                                            <a href="javascript:void(0);" class="text-muted"
                                                onclick="toggleReplies('replies-{{ $comment->id }}', 'icon-{{ $comment->id }}')">
                                                <i class="bi bi-dash-lg"></i> Lihat semua balasan
                                                ({{ $comment->total_replies_count }})
                                                <i id="icon-{{ $comment->id }}" class="ms-3 bi bi-caret-down-fill"></i>
                                            </a>
                                        </p>
                                    </div>
                                @endif
                                ...
                                <div style="height: 100px">
                                    ...
                                    <div class="option mt-3">
                                        <div class="like-count">
                                            ...
                                            <a href="javascript:void(0);" onclick="toggleCommentForm()"
                                                        ...
                                                        <div class="col-9">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ms-2">
                                                                    ...
                                                                    <small
                                                                        class="text-muted">{{ $comment->desc_comment }}</small>
                    ...
                    <div class="detail-banner">
                        <a href="/detail/{{$item->id}}" class="">
                            <img src="{{ asset('storage/foto/' . $item->foto) }}" alt="Fashion Blog Image"
                                style="object-fit: cover; object-position: center; width: 250px; height: 125px;" title="{{$item->title}}">
                        </a>
                    </div>

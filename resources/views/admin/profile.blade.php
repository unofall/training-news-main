                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img src="{{ asset('assets/img/🤨.jpg') }}" alt="Christina Mason" class="img-fluid rounded-circle mb-2"
                        ...
                        <div class="card-body h-100">
                            @foreach ($activities as $activity)
                                <div class="d-flex align-items-start">
                                    <img src="{{ asset('assets/img/🤨.jpg') }}" width="36" height="36"
                                        class="rounded-circle me-2">
                                    <div class="flex-grow-1">
                                        <small class="float-end text-navy">{{ $activity->created_at->diffForHumans() }}
                                        </small>
                                        <strong>{{ $activity->user_id == auth()->id() ? 'You' : $activity->user->name }}
                                        </strong>{{ ucfirst($activity->action) }} {{$activity->blog->categories}} {{$activity->blog->title}}<strong>
                                            </strong><br />
                                        <small class="text-muted">{{ $activity->created_at->format('h:i A') }}
                                        </small><br />

                                        <div class="row g-0 mt-1">
                                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                                <img src="{{ asset('storage/foto/' . $activity->blog->foto) }}" class="img-fluid" alt="Unsplash">
                                            </div>
                                        </div>
        ...
        {{-- <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($activities as $activity)
                    <tr>
                        <td>{{ $activity->blog->title }}</td>
                        <td>{{ Str::limit($activity->blog->description ?? 'No Description', 50) }}</td>

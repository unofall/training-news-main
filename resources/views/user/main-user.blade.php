...
<section class="section posts-entry">
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-md-9">
                <div class="row g-3">
                    @foreach ($blogs->take(2) as $blog) {{-- 2 data pertama --}}
                        <div class="col-md-6">
                            <div class="blog-entry">
                                <a href="" class="img-link">
                                    <img src="{{ asset('storage/foto/' . $blog->foto) }}" alt="{{ $blog->title }}" class="img-fluid img-scale">
                                </a>
                                <span class="date">{{ $blog->created_at->format('M. d, Y') }}</span>
            ...
            <div class="col-md-3">
                <ul class="list-unstyled blog-entry-sm">
                    @foreach ($blogs->skip(2)->take(3) as $blog) {{-- 3 data berikutnya --}}
                        <li>
                            <span class="date">{{ $blog->created_at->format('M. d, Y') }}</span>

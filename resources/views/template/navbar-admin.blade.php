...
<body>
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="/admin/drafts">
                            <i class="align-middle" data-feather="layers"></i> <span class="align-middle">Draft</span>
                        </a>
                    </li>
                    ...
                    <ul class="navbar-nav navbar-align">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img src={{ asset('assets/img/🤨.jpg') }} class="avatar img-fluid rounded me-1"
                                alt="{{ Auth::user()->name }}" /> 
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Event delegation untuk menangani klik pada semua ".sidebar-link"
            // document.addEventListener("click", function(event) {
            //     const link = event.target.closest(".sidebar-link");
            //     if (!link || link.getAttribute("href").startsWith("http")) return; // Abaikan link eksternal
            ...
            //             // Set sidebar-item aktif setelah konten dimuat
            //             setActiveSidebarItem(url);
            //         })
            //         .catch(error => console.error("Error loading page:", error));
            // });

            // Tangani tombol "Back" dan "Forward" di browser
            window.addEventListener("popstate", function() {
                fetch(location.href)
                    ...
                    .then(data => {
                        ...
                        // Perbarui status sidebar-item aktif
                        setActiveSidebarItem(location.pathname);
                    });
            });

            // Set sidebar-item aktif saat halaman pertama kali dimuat
